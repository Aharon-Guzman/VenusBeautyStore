...
//        // ✅ Crear trabajador + usuario Identity + asignar rol (versión simple)
...
//        // ✅ Crear trabajador + usuario Identity + asignar rol (versión con errores detallados)
//        public async Task<(bool Succeeded, IEnumerable<string> Errors)> CrearTrabajadorConErroresAsync(Trabajador trabajador, string password, string rol)
//        {
//            var user = new ApplicationUser
//            {
//                UserName = trabajador.Nombre.ToLower() + "." + trabajador.Apellido.ToLower(),
